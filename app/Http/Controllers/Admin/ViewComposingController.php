...
class ViewComposingController extends Controller {
    ...
    public function buildTemplate($page_name) {
        ...
        $headerCss = array_merge($common_config['headerCss'], $page_config['headerCss']);
        $headerJs = array_merge($common_config['headerJs'], $page_config['headerJs']);
        $footerJs = array_merge($common_config['footerJs'], $page_config['footerJs']);
