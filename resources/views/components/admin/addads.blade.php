...
<div class="">
    <div class="card card-info">
        ...
        <form class="form-horizontal" id=""  method="POST" action="{{ url('admin/ads/store-ads') }}"  enctype="multipart/form-data">
            @csrf
                ...
                <div class="col-sm-6">
                    <div class="form-group row">
                        <label for="cat_name" class="col-sm-3 col-form-label">Ad Name</label>
                            <div class="col-sm-9">
                                <input type="text" name="ad[ad_title]" required value="" class="form-control"  placeholder="Title Name">
                            </div>
                    </div>
                </div>
                ...
                <div class="col-sm-6">
                    <div class="form-group row">
                        <label for="cat_name" class="col-sm-3 col-form-label">Ad Link</label>
                            <div class="col-sm-9">
                                <input type="text" name="ad[ad_link]" required value="" class="form-control"  placeholder="Ad Link">
                            </div>
                    </div>
                </div>
